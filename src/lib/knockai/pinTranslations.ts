...
export interface PinT {
  ...
  typeSale: string; typeNotInterested: string; typeCallBack: string; typeAiKnocked: string;
  descSale: string; descNotInterested: string; descCallBack: string; descAiKnocked: string;
...
export const PIN_T: Record<string, PinT> = {
  en: {
    ...
    typeSale: 'Sale', typeNotInterested: 'Not Interested', typeCallBack: 'Call Back', typeAiKnocked: 'AI Knocked',
    descSale: 'Deal confirmed', descNotInterested: 'Said no', descCallBack: 'Follow up needed', descAiKnocked: 'AI-assisted marker',
  ...
  fr: {
    ...
    typeSale: 'Vente', typeNotInterested: 'Non intéressé', typeCallBack: 'Rappel', typeAiKnocked: 'IA Knocké',
    descSale: 'Vente confirmée', descNotInterested: 'A refusé', descCallBack: 'Suivi requis', descAiKnocked: 'Marqueur assisté par IA',
  ...
  es: {
    ...
    typeSale: 'Venta', typeNotInterested: 'No interesado', typeCallBack: 'Rellamada', typeAiKnocked: 'IA tocada',
    descSale: 'Venta confirmada', descNotInterested: 'Dijo que no', descCallBack: 'Seguimiento necesario', descAiKnocked: 'Marcador asistido por IA',
